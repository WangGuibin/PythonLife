...
def get_info(param, data_table):
    ...
    for i in range(1, total_page):
        url = 'https://www.zhipin.com/c101280600/d_203-h_101280100/?query={0}&page={1}'.format(
            param, i)
...
if __name__ == '__main__':
    param_list = ['java', 'python','iOS']
    table_list = [zhipin_java, zhipin_python,zhipin_iOS]
